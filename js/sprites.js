...
(function (global) {
  'use strict';
  const Sprites = { ready: false, ace: null, enemy: null, pack: null, crew: null };
  ...
  Sprites.load = function () {
    ...
    const ace = {}, enemy = {}, pack = [], crew = [];
    let pending = 0, done = false;
    const finish = () => { if (--pending <= 0 && !done) { done = true; Sprites.ace = ace; Sprites.enemy = enemy; Sprites.pack = pack; Sprites.crew = crew; Sprites.ready = true; } };
