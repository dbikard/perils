...
(function (global) {
  ...
  function newEnemy() {
    return { x: 0, y: 0, r: 10, hp: 10, maxHp: 10, speed: 60, type: null, damage: 6, hitFlash: 0, _active: false, _idx: -1 };
  }
  ...
  global.Entities = { Pool, createPlayer, newEnemy, newProjectile, newCrystal };
